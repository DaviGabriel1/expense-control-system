...
public class TransactionResponseDTO {
    ...
    public TransactionResponseDTO(BigDecimal value, Category category, String description, LocalDateTime datetime, PaymentMethod paymentMethod, Status status, Long userId) {
        this.value = value;
